...
class ObjectAllocator
{
  ...
  private:
    ...
    ObjectAllocator &operator=(const ObjectAllocator &oa);
      ...
      void MakePage() throw(OAException);
      void SetBlockMem(unsigned char * tmp, size_t i);
      void SetHeaderInfo(char * tmp);
      OAConfig oac;
      OAStats oas;
      size_t headSize;
      size_t perObj;
      GenericObject * PageListHead;
      GenericObject * FreeListHead;
};
